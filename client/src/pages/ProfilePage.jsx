    ...
    className='min-h-screen bg-cover bg-no-repeat flex items-center justify-center'>
      ...
      className='w-5/6 max-w-2xl backdrop-blur-2xl text-gray-300 border-2 border-gray-600 flex items-center justify-between max-sm:flex-col-reverse rounded-lg'>
        ...
        className='flex flex-col gap-5 p-10 flex-1'>
          ...
          <input type="file" name="" id="avtar" accept='.png, .jpg, .jpeg' hidden 
          ...
          className='bg-transparent p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-violet-500'/>
